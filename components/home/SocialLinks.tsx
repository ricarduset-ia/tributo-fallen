export function SocialLinks() {
  return (
    <section className="py-8">
      <div className="mx-auto max-w-6xl px-6 flex items-center justify-center gap-4">
        <a
          href="https://twitter.com/fallencs"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Twitter / X — @fallencs"
          className="group w-10 h-10 flex items-center justify-center border border-fallen-bone/20 rounded-full hover:border-fallen-gold hover:bg-fallen-gold/5 transition"
        >
          <svg viewBox="0 0 24 24" className="w-4 h-4 fill-fallen-bone group-hover:fill-fallen-gold transition" aria-hidden="true">
