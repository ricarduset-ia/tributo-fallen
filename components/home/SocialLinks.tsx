export function SocialLinks() {
  return (
    <section className="py-20 border-t border-fallen-bone/5">
      <div className="mx-auto max-w-6xl px-6 flex items-center justify-center gap-6">
        <a
          href="https://twitter.com/fallencs"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Twitter / X — @fallencs"
          className="group w-14 h-14 flex items-center justify-center border border-fallen-bone/20 rounded-full hover:border-fallen-gold hover:bg-fallen-gold/5 transition"
        >
          <svg viewBox="0 0 24 24" className="w-5 h-5 fill-fallen-bone group-hover:fill-fallen-gold transition" aria-hidden="true">
